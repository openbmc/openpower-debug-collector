...
class SbeDumpCollector
{
  ...
  private:
     ...
     * @param targetMap Primary dump targets and their associated chips.  On
     * P10 these are processor/OCMB pairs; on P11/PST they are Hub/OCMB
     * pairs.
     *
