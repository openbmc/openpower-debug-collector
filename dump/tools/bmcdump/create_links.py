...
def install_dreport_user_script(script_path, dreport_dir, plugin_dir, conf_file):
    ...
    srclink = os.path.relpath(script_path, start=dreport_dir)
...
def main():
    ...
    plugin_files = [os.path.join(plugin_dir, f) for f in os.listdir(plugin_dir) if os.path.isfile(os.path.join(plugin_dir, f))]
