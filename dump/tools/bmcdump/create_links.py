...
def install_dreport_user_script(script_path,
                                dreport_dir, plugin_dir, conf_file):
        ...
        for line in file:
            ...
            for type in types:
                ...
                if not os.path.exists(destlink):
                    os.symlink(
                        os.path.relpath(script_path, start=destdir), destlink
                    )
...
def main():
    ...
    for plugin_file in plugin_files:
        install_dreport_user_script(plugin_file, dreport_dir, plugin_dir,
                                    conf_file)
